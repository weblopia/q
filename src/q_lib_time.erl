...
strict_monotonic_seconds() -> q_srv_strict_monotonic_time:get_seconds().
...
strict_monotonic_milliseconds() -> q_srv_strict_monotonic_time:get_milliseconds().
...
strict_monotonic_microseconds() -> q_srv_strict_monotonic_time:get_microseconds().
...
strict_monotonic_nanoseconds() -> q_srv_strict_monotonic_time:get_nanoseconds().
